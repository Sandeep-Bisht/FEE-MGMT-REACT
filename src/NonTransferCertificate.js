    ...
    render(){
        ...
        return(
            ...
            <div className= "row printTc bg-white" style={{textAlign:"justify"}}>
                ...
                <br/>
                <p>Promotion has been ($) <strong> {this.state.result_remark} </strong>.</p>
                </div>
                </div>
            </>
        )
...
export default NonTransferCertificate;