...
const PayScale = () => {
  ...
  const getPayCategoty = () => {
    ...
    const getPayScale = () => {
        fetch("http://144.91.110.221:4800/getPayScale"
        , {
          method: 'POST',
          headers: {
            Accept: 'application/json',
    ...
    const StorePayScale = () => {
      ...
      // console.log(JSON.stringify(AllPayTypeWithValueState))
        ...
        const url = "http://144.91.110.221:4800/StorePayScale"
        fetch(url, {
                method: 'post',
                body: data
            })
    ...
    const UpdatePayScale = () => {
      // console.log(JSON.stringify(AllPayTypeWithValueState))
        ...
        data.append('PayScaleName', PayScaleName)
        data.append('PayScale', JSON.stringify(AllPayTypeWithValueState))
        const url = "http://144.91.110.221:4800/UpdatePayScale"
        fetch(url, {
                method: 'put',
                body: data
            })
  ...
  let DeletePayScale = (id) => {
    const apiUrl = 'http://144.91.110.221:4800/DeletePayScale';
    fetch(apiUrl, {
      headers : { 
        'Content-Type': 'application/json',
        'Accept': 'application/json'
