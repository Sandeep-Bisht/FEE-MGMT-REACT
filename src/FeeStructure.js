...
class FeeStructure extends React.Component{
    ...
    ImportSession =async()=>{
            fetch("http://144:91:110:210:4800/getFeeStructure",{
                method: 'POST',
                headers: {
            ...
            const url = "http://144:91:110:210:4800/storeImportStructure"
            fetch(url, {
                    method: 'post',
                    body: data
                })
    ...
    UpdateFeeStructureData =()=>{
        ...
        const url="http://144:91:110:210:4800/updateFeeStructure"
                fetch(url,
                    {
                    method:'put',
                    body:data
    ...
    submitFeeStructureData = () => {
        ...
        const url = "http://144:91:110:210:4800/StoreFeeStructure"
        fetch(url, {
                method: 'post',
                body: data
            })
