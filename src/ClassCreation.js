...
class ClassCreation extends React.Component {
  ...
  updateCategoryData = () => {
    if (this.checkValidation()) {
      ...
      const url = "http://localhost:4800/updateClass";
      fetch(url, {
        method: "put",
        body: data,
      })
  ...
  deleteClass = (id) => {
    const apiUrl = "http://localhost:4800/deleteClass";
    fetch(apiUrl, {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
  ...
  submitClassData = async () => {
    ...
    if (this.checkValidation()) {
      ...
      // data.append('session', this.state.session)
      data.append("school_id", "UT015");
      const url = "http://localhost:4800/StoreClass";
      fetch(url, {
        method: "post",
        body: data,
      })
          ...
          action: (
            <td>
              <button
                ...
                onClick={() => this.editClassObject(item)}
              >
              ...
              <div className="col-3 form-group">
                ...
                <input
                  ...
                  onChange={(e) => {
                    {
                      this.setState({
                        class_name: e.target.value.toUpperCase(),
                        class_nameErrorMessage: undefined,
                      });
                    }
                  }}
                />
                ...
                >
                  {this.state.class_nameErrorMessage}
                </span>
              </div>
              <div className="col-3 form-group">
                ...
                <select
                  className="form-control"
                  value={this.state.actual_class}
                  onChange={(e) => {
                    {
                      this.setState({
                        actual_class: e.target.value.toUpperCase(),
                        actual_classErrorMessage: undefined,
                      });
                    }
                  }}
                >
                ...
                <span
                  ...
                  style={{ fontSize: "14px", fontWeight: 600 }}
                >
                  {this.state.actual_classErrorMessage}
                </span>
              </div>
              <div className="col-3 form-group">
              ...
              <div className="col-3 form-group">
                ...
                {this.state.updateBtn ? (
                  <button
                    ...
                    type="submit"
                    onClick={(e) => this.updateCategoryData(e)}
                  >
                    Update
                  </button>
                ) : null}
