...
class FeeVoucher extends React.Component {
  ...
  getFeeSummary = async () => {
    ...
    await console.log("wait")
    fetch("http://localhost:4800/getFeeSummary"
      , {
        method: 'POST',
        headers: {
          Accept: 'application/json',
  ...
  VoucherByDate = async () => {
    ...
    paidamountbyclass = 0
    await console.log("wait")
    fetch("http://localhost:4800/VoucherByDate"
      , {
        method: 'POST',
        headers: {
          Accept: 'application/json',
  ...
  printvoucherbydate = async () => {
    ...
    paidamountbydate = 0
    paidamountbyclass = 0
    fetch("http://localhost:4800/printvoucherbydate"
      , {
        method: 'POST',
        headers: {
          Accept: 'application/json',
  ...
  SuspiciousVoucherByDate = async () => {
    ...
    fetch("http://localhost:4800/SuspiciousVoucherByDate"
      , {
        method: 'POST',
        headers: {
          Accept: 'application/json',
  ...
  VoucherInDetail = async () => {
    ...
    paidamountbyclass = 0
    await console.log("wait")
    fetch("http://localhost:4800/VoucherInDetail"
      , {
        method: 'POST',
        headers: {
          Accept: 'application/json',
  ...
  VoucherByClass = async () => {
    ...
    paidamountbyclass = 0
    await console.log("wait")
    fetch("http://localhost:4800/VoucherByClass"
      , {
        method: 'POST',
        headers: {
          Accept: 'application/json',
