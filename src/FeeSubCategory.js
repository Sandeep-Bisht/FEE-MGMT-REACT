...
class FeeCategory extends React.Component{
    ...
    UpdateFeeSubCategoryData =()=>{
        ...
        const url="http://144:91:110:210:4800/updateFeeSubCategory"
                fetch(url,
                    {
                    method:'put',
                    body:data
      ...
      deleteFeeSubCategory = (id) => {
        const apiUrl = 'http://144:91:110:210:4800/deleteFeeSubCategory';
        fetch(apiUrl, {
          headers : { 
    ...
    submitSubCategoryData = () => {
        ...
        data.append('month', this.state.month)
        data.append('status', this.state.status)
        const url = "http://144:91:110:210:4800/StoreFeeSubCatogory"
        fetch(url, {
                method: 'post',
                body: data
            })
            ...
            <div className="row layoutCard">
                <div className="col-12">
                    <div className="form-row">
                        ...
                        <div className="col-4 form-group constancia-form-group">
                           <label>Month </label>
