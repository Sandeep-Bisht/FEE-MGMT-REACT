...
class FeeCategory extends React.Component{
    ...
    UpdateFeeSubCategoryData =()=>{
        ...
        const url="http://localhost:4800/updateFeeSubCategory"
                fetch(url,
                    {
                    method:'put',
                    body:data
      ...
      deleteFeeSubCategory = (id) => {
        const apiUrl = 'http://localhost:4800/deleteFeeSubCategory';
        fetch(apiUrl, {
          headers : { 
    ...
    submitSubCategoryData = () => {
        ...
        data.append('month', this.state.month)
        data.append('status', this.state.status)
        const url = "http://localhost:4800/StoreFeeSubCatogory"
        fetch(url, {
                method: 'post',
                body: data
            })
