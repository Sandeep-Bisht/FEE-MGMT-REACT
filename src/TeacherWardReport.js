...
class TeacherWardReport extends React.Component{
    constructor(props){
        super(props)
        this.state={
          AllStudent:[],
            ...
            <>
              ...
              <div className= "row printCard printDefaulter">
                  <div className="col-12 text-center">
                    <h3 className="pb-5"> <u>{this.state.session} TEACHER WARD STUDENTS LIST ({this.state.class_name==""?"ALL CLASSES":this.state.class_name})</u> </h3>
                  </div>
                  <table class="table table-striped">
                        ...
                        this.state.AllStudent.sort((a,b) => parseInt(a.class_name) - parseInt(b.class_name)).map((item,index)=>{
                          ...
                          if(item.student.is_teacher_ward=="true" && item.class_name+item.section==it.class_name+it.section){ 
...
export default TeacherWardReport;