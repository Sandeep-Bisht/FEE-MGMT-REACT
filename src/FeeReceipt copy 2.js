...
class FeeReceipt extends React.Component{
    ...
    searchByAdmission_no= async (e)=>{
        ...
        previousfine=0
        this.setState({paid_amount:'0',last_fee_date:'',fee_concession:'',tc_status:'',remaning_balance:'0',defaultFine:'',fine:'0',balance:'0',account_no:'', total_monthly_fee:'0',one_time_fees:'0',months:[],annual_fee:'0',AllOldFees:[],month:[],shortmonths:[],feemonths:[],name:'',grand_total:'',father_name:'',parent_mobile:'',parent_phone:'',mother_name:'',Allfees:[],AllDummyfees:[],Actualfees:[],due:'0',surplus:'0',last_fees_date:'',take_computer:"",is_full_free_ship:"",is_teacher_ward:"",StudentTutionFee:'0'})
    ...
    setBalance =async()=>{
        ...
        if(this.state.paid_amount=="0"){
            ...
            while (dateEnd > dateStart || dateStart.format('M') === dateEnd.format('M') ) {
                // if(shortmonths.includes('3')==true || Moment(this.state.last_fees_date).format('M')=="3")
        ...
        while( paidAmount >0  ){
            ...
            if(getOneTimeFeesinpaidAmount == true ){
                ...
                if(parseInt(this.state.fee_concession) > 0 && this.state.fee_concession != ""){
                 paidAmount = paidAmount - student_tuition_fee-calculateOneTimeFee-700
                }else{
                    ...
                    if(i==item.month){
                        ...
                        if(item.fee_sub_category.includes("COMPUTER") !=true ){
                                if(parseInt(item.amount)>0){
                                    annual_fees =(annual_fees+parseInt(item.amount))/2
                                }else{
                                annual_fees =(annual_fees+parseInt(item.amount))
                                }
                            }else{
...
// })} 
    ...
    //    let grand_total = parseInt(this.state.tution_fee)+parseInt(this.state.science_fee)+parseInt(this.state.bus_fare)  
        ...
        //    grand_total = grand_total+parseInt(this.state.report_card_and_diary)+parseInt(this.state.annual_prize_day)+parseInt(this.state.development_fund)+parseInt(this.state.school_magazin)+parseInt(this.state.annual_sports_day)+parseInt(this.state.examination_fee)+parseInt(this.state.med_board_reg)+parseInt(this.state.library_fee)
           
        //    if(this.state.TakeHalfYearlyFee == true){
        //     grand_total = grand_total+parseInt(this.state.computer_fee)
        //    }
        // console.log("PAID FEES " +JSON.stringify( this.state.paidFees))
                            ...
                            <div className="row">
                             ...
                             <option value="">All Session</option>
                              {this.state.AllSession.map((item,index)=>{
                                ...
                                <div className="col-5">
                                    <strong>Admn No - </strong> <input type="text"  value={this.state.admission_no} onFocus={(e)=>{this.handleFocusInput(e)}} onChange={(e)=>{this.setState({admission_no:e.target.value});this.searchByAdmission_no()}} />  <button type="button" onClick={()=>{this.getStudent()}} class="btn btn-success btn-sm" data-toggle="modal" data-target="#AllModalStudent">...</button><br/>
                    ...
                    <div className="form-row">
                        ...
                        <div className="col-3 form-group">
                            <div className="form-row">
                                    ...
                                    <div className="col-8 form-group">    
                                        <input type="text"   value={this.state.admission_no} onFocus={(e)=>{this.handleFocusInput(e)}} onChange={(e)=>{this.setState({admission_no:e.target.value.toUpperCase(),admission_noErrorMessage:undefined}); this.searchByAdmission_no(e)}} tabindex="2" className="w-50" />
                        ...
                        {this.state.AllStudent.map((item,index)=>{
                         ...
                         <div className="col-3 ">
                            <label style={{backgroundColor:"#000a80",color:"white",padding:"5px"}}>Paid Upto : {Moment(this.state.last_fees_date).format("M")=='1' ? "Jan "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='2' ? "Feb "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='3' ? "Mar "+Moment(this.state.feemonths[0]).format("YYYY")  : Moment(this.state.last_fees_date).format("M")=='4' ? "Apr "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='5' ? "May "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='6' ? "Jun "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='7' ? "July "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='8' ? "Aug "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='9' ? "Sept "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='10' ? "Oct "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='11' ? "Nov "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='12' ? "Dec "+Moment(this.state.feemonths[0]).format("YYYY"):null}
                            </label>
                        </div>
                        <div className="col-2 ">
                            <label>Fee From : {this.state.fromtomonths[0]=='1' ? "Jan "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='2' ? "Feb "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='3' ? "Mar "+Moment(this.state.feemonths[0]).format("YYYY")  : this.state.fromtomonths[0]=='4' ? "Apr "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='5' ? "May "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='6' ? "Jun "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='7' ? "July "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='8' ? "Aug "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='9' ? "Sept "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='10' ? "Oct "+Moment(this.state.feemonths[0]).format("YYYY") : this.state.fromtomonths[0]=='11' ? "Nov "+Moment(this.state.feemonths[0]).format("YYYY") : Moment(this.state.last_fees_date).format("M")=='12' ? "Dec "+Moment(this.state.feemonths[0]).format("YYYY"):null}
                            </label>
                        </div>
                        <div className="col-2 ">
                        ...
                        {/* next row */}
                        <div className="col-2 ">
                         <th >Month : <input type="text" className="w-25" value={this.state.fromtomonths.length} onChange={(e)=>{this.ChangeFeeDate(e)}} /></th>
                        </div>
                        <div className="col-2 ">
